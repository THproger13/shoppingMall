...
public class PurchaseController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/purchase/read":
			...
			request.setAttribute("array", dao.orderList(pid));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/purchase/insert":
			...
			vo.setRecName(request.getParameter("uname"));
			vo.setRecAddress1(request.getParameter("address1"));
			vo.setRecAddress2(request.getParameter("address2"));
			vo.setRecPhone(request.getParameter("phone"));
			vo.setSum(Integer.parseInt(request.getParameter("sum")));
