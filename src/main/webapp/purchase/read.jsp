	...
	<div class="col">
		...
		<div class="card">
			<div class="row p-3">
				...
				<div class="col-lg-3">전화번호: ${vo.recPhone}</div>
				<div class="col-lg-3">주문일: ${vo.purDate}</div>
			</div>
			<hr>
			<div class="row p-3">
				<div class="col-lg-6">주소: ${vo.recAddress1} ${vo.recAddress2}</div>
				<div class="col">주문총금액: <fmt:formatNumber value="${vo.sum}" pattern="#,###원"/></div>
